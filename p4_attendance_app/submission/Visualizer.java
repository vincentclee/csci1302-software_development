...
public class Visualizer extends JFrame {
	...
	public Visualizer() {
		...
		setTitle("iTracker Pro 2012 v10.6.0.40");
	...
	private void lanuchControl() {
		...
		if (file.exists()) {
			...
			if (selectedFile.exists()) {
			    ...
			    setTitle("iTracker Pro - " + selectedFile.getName());
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (status == JFileChooser.APPROVE_OPTION) {
				...
				for (int i = 0; i < selectedFile.length; i++)
					queue.add(selectedFile[i].getName());
				
				//Shows user that the files are being processed. 
				JOptionPane.showMessageDialog(null, "The attendance files: " + queue.toString() + " are being processed.");
	...
	private class OpenListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (status == JFileChooser.APPROVE_OPTION) {
			    ...
			    //Displays filename through title.
			    setTitle("iTracker Pro - " + fileName);
	...
	private class GetStartedListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			JOptionPane.showMessageDialog(null, "<html>Congratulations on your purchase of iTracker Pro!<br/>" +
	...
	private class AboutListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			//About message.
			JOptionPane.showMessageDialog(null, new JLabel("<html><center>iTracker Pro 2012 v10.6.0.40<br/>" +
					"Vincent Lee<br/>Glenn Maust<br/>" +
